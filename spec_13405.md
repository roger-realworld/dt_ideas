...
Depending on the number of further Gf cables arriving at a socket, there may be several situations in which the fiber 2 goes to fiber 1 (return to the main strand).
...
If more than 5 fiber-optic cables arrive at the socket, an info object must be created during the transfer, so that the water fiber of the sixth fiber-optic cable arriving at the socket could no longer be automatically stored on the GF-cassette 1.3 and thus must be done manually.
